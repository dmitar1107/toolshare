Template.home.events({
    ...
    'click input.rent_btn': function () {
        Router.go('/rent/userlocation');
    },

    'click input.loan_btn': function () {
    	if (Meteor.user() == null) {
            ...
            // Meteor.Router.to( '/loan' );
    },
    'click input.test_btn': function () {
        Meteor.call("setMail");
    }
});

Template.home.serveCurrent = function() {
    console.log("** serveCurrent ***" + Session.get('currentPage'));
...
//            a.addEventListener(c, b, false); 
    ...
    ab.prototype = {c: function () {
        ...
        if (this.z(h) && h[p]("autoPlayVideo") == "true")this.d(h); else if (a.i && b.d > 1)q = setTimeout(function () {g.y(g.n(1), 0, 1)
                                                                                                           }, a.b + a.c);
        if (a.h) {
        ...
        if (Z() == 300)
            e[c]["-webkit-transform"] = "translate3d(0,0,0)"}, d: function (c) {
                ...
                if (c < 9) this.q(f, c); else if (c < 13)this.r(f, c); else if (c == 13)this.s(f); else if (c < 16)this.t(f, c); else this.u(f, c)
                        ...
                        for (var k = [], j = i > 8 ? s : Math.round(s / a.f), l = i > 8 ? 1 : a.f, h = 0; h < l; h++) {
                            ...
                            if (i == 10)f[c][J] = 'url("' + b.e[p]("src") + '") no-repeat right top'; else if (i == 12)f[c][J] = 'url("' + b.e[p]("src") + '") no-repeat left bottom';
                            f[c].zIndex = 1;
